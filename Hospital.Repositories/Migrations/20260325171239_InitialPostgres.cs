        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDoctor = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorCharge = table.Column<int>(type: "integer", nullable: false),
                    MedicineCharge = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    RoomCharge = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    OperationCharge = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    NoOfDays = table.Column<int>(type: "integer", nullable: false),
                    NursingCharge = table.Column<int>(type: "integer", nullable: false),
                    LabCharge = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LabNumber = table.Column<string>(type: "text", nullable: true),
                    PatientId = table.Column<string>(type: "text", nullable: true),
                    ...
                    TestValue = table.Column<double>(type: "double precision", nullable: true),
                    TestResults = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EmployeeIdId = table.Column<string>(type: "text", nullable: true),
                    Salary = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    NetSalary = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    HourlySalary = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    BonusSalary = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MedicineId = table.Column<int>(type: "integer", nullable: false),
                    PatientReportId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
